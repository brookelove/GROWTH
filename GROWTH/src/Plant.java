...
class Succulent extends Plant {
    ...
    public Succulent(String id, String commonName, Integer potSize, Float price, String variegation, Boolean hasSpines,
            ArrayList<String> succulentInfo) {
...
class Foliage extends Plant {
    public Foliage(String id, String commonName, Integer potSize, String vareigation, Float price,
            ArrayList<String> foliageInfo) {
        super(id, commonName, potSize, price, vareigation, foliageInfo);
    }

    public void pruneLeaves() {
        System.out.printf("Please check your leaves of the %s plant to make sure that there are no pre-dying leaves",
                getName());
    }
